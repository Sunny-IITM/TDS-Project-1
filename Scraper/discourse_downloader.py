...
CATEGORY_ID = 34
START_DATE = "2024-11-07" # Inclusive
END_DATE = "2025-04-15"   # Inclusive

RAW_COOKIE_STRING = """
ADD_YOUR_COOKIE""" # Replace with your actual cookie string

OUTPUT_DIR = "discourse_json"
POST_ID_BATCH_SIZE = 50
MAX_CONSECUTIVE_PAGES_WITHOUT_NEW_TOPICS = 10 # New configuration for breaking loop
